...
def check_login():
    ...
    if not st.session_state.logged_in:
        ...
        st.markdown(
        "<h1 style='text-align:center;color:#FFD700'>🛡️ PREMIER LEAGUE ANALYTICS UNIT</h1>",
        unsafe_allow_html=True
        )
                ...
                with st.form("login_form"):
                    ...
                    if btn:
                        ...
                        # user ที่ register
                            ...
                            st.session_state.logged_in=True
                            st.session_state.user_role="GUEST"   # ใช้ role GUEST
                            st.session_state.username=user
                            st.rerun()
        ...
        with tab2:
            ...
            with col2:
                ...
                with st.form("register_form"):
                    ...
                    reg_btn=st.form_submit_button("📝 สมัครสมาชิก")
...
if check_login():
    ...
    if uploaded_file:
        ...
        # ADMIN + GUEST ใช้ logic เดียวกัน
        ...
        if "ตำแหน่ง" in df.columns:
            ...
            search_pos=st.sidebar.multiselect(
            "🏃 ตำแหน่ง",
            pos_list,
            default=pos_list
            )
...
#----------------
            ...
            if user_role=="GUEST":
                ...
                st.warning("🔒 ข้อมูลวิเคราะห์สงวนสิทธิ์")
            ...
            # -------- ADMIN / CLUB --------
                ...
                fig = go.Figure()
                fig.add_trace(go.Scatter(x=df_p['ชื่อนักเตะ'], y=df_p['คะแนนครั้งก่อน'], name='ครั้งก่อน',
                                         line=dict(color='#FF4B4B', dash='dot')))
                fig.add_trace(go.Scatter(x=df_p['ชื่อนักเตะ'], y=df_p['คะแนนรวม'], name='ล่าสุด',
